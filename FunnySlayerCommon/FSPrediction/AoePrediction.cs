...
namespace IreliaE.FunnySlayerCommon.FSPrediction
{
	public static class AoePrediction
	{
		public static PredictionOutput GetPrediction(EnsoulSharp.SDK.PredictionInput input)
		{
			switch (input.Type)
			{
				case (SpellType)SkillshotType.SkillshotLine:
					return AoePrediction.Line.GetPrediction(input);
				case (SpellType)SkillshotType.SkillshotCircle:
					return AoePrediction.Circle.GetPrediction(input);
				case (SpellType)SkillshotType.SkillshotCone:
		...
		internal static List<AoePrediction.PossibleTarget> GetPossibleTargets(EnsoulSharp.SDK.PredictionInput input)
		{

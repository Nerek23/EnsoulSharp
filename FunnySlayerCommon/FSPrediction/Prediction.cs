...
namespace IreliaE.FunnySlayerCommon.FSPrediction
{
	public static class Prediction
	{
		public static PredictionOutput GetPrediction(this Spell spell, AIBaseClient unit, bool aoe = false, float overrideRange = -1f, CollisionableObjects[] collisionable = null)
		{
			...
			return Prediction.GetPrediction(new EnsoulSharp.SDK.PredictionInput
			{
		...
		public static PredictionOutput GetPrediction(this Spell spell, AIBaseClient unit, out EnsoulSharp.SDK.PredictionInput getinput, bool aoe = false, float overrideRange = -1f, CollisionableObjects[] collisionable = null)
		{
			bool flag = false;
			...
			getinput = new EnsoulSharp.SDK.PredictionInput
			{
				CollisionYasuoWall = false,
				Unit = unit,
				Delay = spell.Delay,
		...
		public static PredictionOutput GetPrediction(EnsoulSharp.SDK.PredictionInput input)
		{
		...
		public static PredictionOutput GetDashingPrediction(EnsoulSharp.SDK.PredictionInput input)
		{
		...
		public static PredictionOutput GetImmobilePrediction(EnsoulSharp.SDK.PredictionInput input, double remainingImmobileT)
		{
		...
		internal static PredictionOutput GetPositionOnPath(EnsoulSharp.SDK.PredictionInput input, List<Vector2> path, float speed = -1f)
		{
		...
		public static PredictionOutput GetPrediction(EnsoulSharp.SDK.PredictionInput input, bool ft, bool checkCollision)
		{
		...
		public static PredictionOutput GetStandardPrediction(EnsoulSharp.SDK.PredictionInput input)
		{
